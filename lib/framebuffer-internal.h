...
#     define PI_REV1_RGB_PINOUT_
...
#elif defined(CM_5_CHAIN_SUPPORT)
  // Compute Module IO board pinout  
  // This uses the PWM pin to create the timing.
  union IoBits0 {
    struct {
      // This bitset reflects the GPIO bank 0 mapping. The naming of the
      // pins of type 'p0_r1' means 'first parallel chain, red-bit one'
      // Setup is meant to emulate non-CM raspberry pis for bank 0
      //                                 GPIO Header-pos
      unsigned int unused_0_1     : 2;  //  0..1  (only on RPi 1, Revision 1)
  ...
  union IoBits1 {
    struct {
      // This bitset reflects the GPIO bank 1 mapping. The naming of the
      // pins of type 'p3_r1' means 'fourth parallel chain, red-bit one'
      //                                 GPIO Header-pos
      unsigned int p3_r1          : 1;  //  32  
      unsigned int p3_g1          : 1;  //  33
      unsigned int p3_b1          : 1;  //  34
      unsigned int p3_r2          : 1;  //  35
      unsigned int p3_g2          : 1;  //  36
      unsigned int p3_b2          : 1;  //  37

      unsigned int p4_r1          : 1;  //  38  
      unsigned int p4_g1          : 1;  //  39
      unsigned int p4_b1          : 1;  //  40
      unsigned int p4_r2          : 1;  //  41
      unsigned int p4_g2          : 1;  //  42
  ...
  IoBits0 *bitplane_buffer_0;
  inline IoBits0 *ValueAt_0(int double_row, int column, int bit);

#ifdef CM_5_CHAIN_SUPPORT
  IoBits1 *bitplane_buffer_1;
  inline IoBits1 *ValueAt_1(int double_row, int column, int bit);
#endif
};
}  // namespace internal
}  // namespace rgb_matrix
